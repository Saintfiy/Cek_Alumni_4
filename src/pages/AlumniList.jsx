                ...
                >
                  ...
                  <div className="col-sosmed">
                    <div className="sosmed-group">
                      {row.linkedin && (
                        <a href={row.linkedin} target="_blank" rel="noreferrer" className="sosmed-link" title="LinkedIn">
                      ...
                      {row.instagram && (
                        <a href={row.instagram} target="_blank" rel="noreferrer" className="sosmed-link" title="Instagram">
